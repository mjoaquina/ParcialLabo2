...
//    public void listarRecaudacion()
//    {
//        int[] vCurso = new int[10];
//
...
//    }
//
//    public void cargarVRecaudacion(int vCurso[]) {
...
//
//    public void listarAlumnosNoMorosos() {
//        PagosArchivo pagoArch;
...
//
//    }
//    public boolean calcularSoloUnCurso(int legajo) {
//        PagosArchivo pagoArch;
//        int cantidad = pagoArch.getCantidad();
//        int cuantosCursos = 0;
//        boolean vCursos[10]{};
//        boolean soloUnCurso = false;
//
//        for (int i = 0; i < cantidad; i++) {
...
//
//    }
//    public float calcularRecaudacion(int anio, int cantidad) {
//        PagosArchivo reg;
